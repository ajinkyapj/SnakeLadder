...
echo "***First Player***"
                ...
                let DiceCount2+=1
                check=$((RANDOM%3))
                choice2=${option[$check]}
                echo "$choice2"
                if [[ $choice2 == 'Ladder' ]]
                then
                   let LadderMove=$MovesCount2
                        let LadderMove+=n
                        echo "Ladder Move: $n"
                        if [[ $LadderMove -gt 100 ]]
                        then
                        ...
                        then
                                echo "Second Player WON and Dice Rolled $DiceCount2 and Total Moves are $move2"
                                echo "First Player Lost and Dice Rolled $DiceCount1 and Total Moves are $move1"
                ...
                echo "Second player moves on: $MovesCount2"
done
